      ...
      {searchOpen && (
        <div className="relative z-20 px-6 pt-3 flex-shrink-0">
          <form onSubmit={handleSearch}>
            <div
              className="flex items-center gap-3 rounded-2xl px-4 py-2.5 glass-input"
            >
        ...
        {loading ? (
          <div className="flex-1 flex flex-col gap-6">
            <div className="flex items-center gap-5">
              <div className="w-20 h-20 rounded-full animate-pulse flex-shrink-0" style={{ background: 'var(--surface-mid)', opacity: 0.6 }} />
