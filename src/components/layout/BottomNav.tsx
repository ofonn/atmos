    ...
    <nav
      className={
        inline
          ...
          : 'fixed bottom-4 md:bottom-5 left-1/2 -translate-x-1/2 z-40 w-full max-w-xl px-4 md:px-0 flex justify-center'
      }
      aria-label="Main navigation"
    >
      <div className="flex items-end justify-between md:justify-center gap-1 md:gap-4 px-3 py-1.5 md:py-2 rounded-full nav-glass w-full md:w-auto">
        {navItems.map(({ href, icon: Icon, label }) => {
          ...
          return (
            <Link
              ...
              className={`flex flex-col items-center justify-center gap-0.5 min-w-[48px] min-h-[44px] md:min-h-[48px] px-2 py-0.5 md:py-1 rounded-full transition-all duration-300 active:scale-90 ${
            ...
            >
              ...
              <span
                className={`font-label text-[10px] md:text-[11px] leading-none tracking-wide transition-colors ${
